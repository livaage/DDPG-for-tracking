...
def get_critic():
    ...
    action_convolution = layers.Conv1D(256, kernel_size=num_close_hits, activation='relu')(comp_out)
    #action_convolution = layers.MaxPooling1D((4))(action_convolution)
    action_convolution = layers.Dense(564, activation="relu")(action_convolution) 
    action_convolution = layers.Dense(264, activation="relu")(action_convolution) 

    action_convolution = layers.Dense(64, activation="relu")(action_convolution) 
    ...
    concat2 = layers.Concatenate()([state_out, action_out, action_convolution])

    out = layers.Dense(512, activation="relu")(concat2)
    out = layers.Dense(128, activation="relu")(out)    #action_convolution = layers.Dense(64, activation="relu")(action_convolution) 
